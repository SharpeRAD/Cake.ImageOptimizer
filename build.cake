...
// Define directories.
var buildDir = "./src/ImageOptimizer/bin/" + configuration;
var buildTestDir = "./src/ImageOptimizer.Tests/bin/" + configuration;
...
// Package
var zipPackage = buildResultDir + "/Cake-ImageOptimizer-v" + semVersion + ".zip";
...
{
    // Addin
    CopyFileToDirectory(buildDir + "/Cake.ImageOptimizer.dll", binDir);
...
Task("Create-NuGet-Packages")
    ...
    .Does(() =>
{
    NuGetPack("./nuspec/Cake.ImageOptimizer.nuspec", new NuGetPackSettings
    {
        Version = version,
    ...
    .Does(() =>
{
    ...
    // Push the package.
    var package = nugetRoot + "/Cake.ImageOptimizer." + version + ".nupkg";
